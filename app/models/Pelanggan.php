...
class pelanggan extends Model
{
      ...
      public function simpan()
      {
            ...
            $sql = "INSERT INTO tb_pelanggan (pel_id_gol,pel_no,pel_nama,pel_ktp,pel_meteran, pel_aktif,pel_id_user) VALUES (:pel_id_gol,:pel_no,:pel_nama,:pel_ktp,:pel_meteran, :pel_aktif,:pel_id_user)";
      ...
      public function update()
      {
            ...
            $sql = "UPDATE tb_pelanggan SET pel_nama=:pel_nama, pel_ktp=:pel_ktp, pel_aktif=:pel_aktif WHERE pel_id=:pel_id";
            $stmt = $this->db->prepare($sql);
            $stmt->bindParam(":pel_nama", $pel_nama);
            $stmt->bindParam(":pel_ktp", $pel_ktp);
            $stmt->bindParam(":pel_aktif", $pel_aktif);
